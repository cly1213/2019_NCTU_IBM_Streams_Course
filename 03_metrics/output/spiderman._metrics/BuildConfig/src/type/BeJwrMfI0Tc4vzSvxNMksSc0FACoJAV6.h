...
#ifndef BEJWRMFI0TC4VZSVXNMKSSC0FACOJAV6_H_
#define BEJWRMFI0TC4VZSVXNMKSSC0FACOJAV6_H_
...
public:
    ...
    typedef SPL::int64 count_type;
    typedef SPL::int64 item_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple(), count_(), item_() {}
    SELF(const Self & ot) : Tuple(), count_(ot.count_), item_(ot.item_) 
      { constructPayload(ot); }
    SELF(const count_type & _count, const item_type & _item) : Tuple(), count_(_count), item_(_item) { }
    ...
    item_type & get_item() { return item_; }
    const item_type & get_item() const { return item_; }
    void set_item(const item_type & _item) { item_ = _item; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<item_type >()(item_);
        return s;
    }
    
    size_t getSerializedSize() const
    {
        size_t size = sizeof(SPL::int64)+sizeof(SPL::int64);
...
#undef SELF
#endif // BEJWRMFI0TC4VZSVXNMKSSC0FACOJAV6_H_ 
