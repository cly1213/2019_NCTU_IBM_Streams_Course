// t4s6symbolf5priceu8quantitys9tradeType


#ifndef BEJWRMSK2K67MTCRPSTMTKMPMTI21KCXNZCVJLKKSTIWPSKXJDAKSSAUAIO4PAG_H_
#define BEJWRMSK2K67MTCRPSTMTKMPMTI21KCXNZCVJLKKSTIWPSKXJDAKSSAUAIO4PAG_H_
...
#define SELF BeJwrMSk2K67MTcrPSTMtKMpMTi21KCxNzCvJLKkstiwpSkxJDaksSAUAIo4PAg
...
public:
    ...
    SELF() : Tuple(), symbol_(), price_(), quantity_(), tradeType_() {}
    SELF(const Self & ot) : Tuple(), symbol_(ot.symbol_), price_(ot.price_), quantity_(ot.quantity_), tradeType_(ot.tradeType_) 
      { constructPayload(ot); }
    SELF(const symbol_type & _symbol, const price_type & _price, const quantity_type & _quantity, const tradeType_type & _tradeType) : Tuple(), symbol_(_symbol), price_(_price), quantity_(_quantity), tradeType_(_tradeType) { }
    ...
    {
        buf << symbol_ << price_ << quantity_ << tradeType_;
    }
...
#undef SELF
#endif // BEJWRMSK2K67MTCRPSTMTKMPMTI21KCXNZCVJLKKSTIWPSKXJDAKSSAUAIO4PAG_H_ 
