...
#include "BeJwrMSk2yUvMTS01ykwpNi3JLMlJTTMrTsxJLKoEAIzYApX.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring name,uint32 id,rstring title,float32 salary>",&initer));
