...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple, uint32_t port) 
{
   ...
   AutoPortMutex (_mutex, *this);
    ...
    if (((((iport$0.get_id() == lit$3) || (iport$0.get_id() == lit$2)) || (iport$0.get_id() == lit$1)) || (iport$0.get_id() > lit$0)))
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("PSR",&initer));
    return true;
}
