// t4s4namei2idi4ranks5major


#ifndef BEJWRMSK2YUVMTC00YKZJNCLKZMSUNS1NZMOVAGB23GLJ_H_
#define BEJWRMSK2YUVMTC00YKZJNCLKZMSUNS1NZMOVAGB23GLJ_H_
...
#define SELF BeJwrMSk2yUvMTc00ykzJNClKzMsuNs1NzMovAgB23glj
...
public:
    ...
    typedef SPL::int32 id_type;
    typedef SPL::int32 rank_type;
    typedef SPL::rstring major_type;

    enum { num_attributes = 4 } ;
    
    SELF() : Tuple(), name_(), id_(), rank_(), major_() {}
    SELF(const Self & ot) : Tuple(), name_(ot.name_), id_(ot.id_), rank_(ot.rank_), major_(ot.major_) 
      { constructPayload(ot); }
    SELF(const name_type & _name, const id_type & _id, const rank_type & _rank, const major_type & _major) : Tuple(), name_(_name), id_(_id), rank_(_rank), major_(_major) { }
    ...
    rank_type & get_rank() { return rank_; }
    const rank_type & get_rank() const { return rank_; }
    void set_rank(const rank_type & _rank) { rank_ = _rank; }
    major_type & get_major() { return major_; }
    const major_type & get_major() const { return major_; }
    void set_major(const major_type & _major) { major_ = _major; }
    ...
    size_t hashCode() const
    {
        ...
        s = 37 * s + std::tr1::hash<rank_type >()(rank_);
        s = 37 * s + std::tr1::hash<major_type >()(major_);
        return s;
    }
   ...
   size += major_.getSerializedSize();
    ...
    { 
        ...
        std::swap(id_, ot.id_);
        std::swap(rank_, ot.rank_);
        std::swap(major_, ot.major_);
...
#undef SELF
#endif // BEJWRMSK2YUVMTC00YKZJNCLKZMSUNS1NZMOVAGB23GLJ_H_ 
