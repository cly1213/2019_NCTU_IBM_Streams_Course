...
#ifndef BEJWRMSO1TYZPK811M02OT0RMAQAWRGXN_H_
#define BEJWRMSO1TYZPK811M02OT0RMAQAWRGXN_H_
...
#define SELF BeJwrMSo1TYzPK811M02OT0rMAQAwrgXN
...
public:
    ...
    SELF() : Tuple(), a_num_(), c_bal_() {}
    SELF(const Self & ot) : Tuple(), a_num_(ot.a_num_), c_bal_(ot.c_bal_) 
      { constructPayload(ot); }
    SELF(const a_num_type & _a_num, const c_bal_type & _c_bal) : Tuple(), a_num_(_a_num), c_bal_(_c_bal) { }
    ...
    {
        size_t size = sizeof(SPL::uint32)+sizeof(SPL::float64);
...
#undef SELF
#endif // BEJWRMSO1TYZPK811M02OT0RMAQAWRGXN_H_ 
