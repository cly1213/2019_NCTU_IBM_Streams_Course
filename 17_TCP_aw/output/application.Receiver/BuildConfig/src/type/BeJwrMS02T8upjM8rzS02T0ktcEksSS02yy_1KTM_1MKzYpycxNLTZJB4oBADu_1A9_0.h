...
#ifndef BEJWRMS02T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNLTZJB4OBADU_1A9_0_H_
#define BEJWRMS02T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNLTZJB4OBADU_1A9_0_H_
...
public:
    ...
    SELF() : Tuple(), fly_num_(), depDate_(), origin_(), time_(), gate_() {}
    SELF(const Self & ot) : Tuple(), fly_num_(ot.fly_num_), depDate_(ot.depDate_), origin_(ot.origin_), time_(ot.time_), gate_(ot.gate_) 
      { constructPayload(ot); }
    SELF(const fly_num_type & _fly_num, const depDate_type & _depDate, const origin_type & _origin, const time_type & _time, const gate_type & _gate) : Tuple(), fly_num_(_fly_num), depDate_(_depDate), origin_(_origin), time_(_time), gate_(_gate) { }
    ...
    {
        buf << fly_num_ << depDate_ << origin_ << time_ << gate_;
    }
...
#undef SELF
#endif // BEJWRMS02T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNLTZJB4OBADU_1A9_0_H_ 
