// t4s7fly_nums7depDates6origins4time


#ifndef BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNBQDKIQ01_H_
#define BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNBQDKIQ01_H_
...
#define SELF BeJwrMSk2T8upjM8rzS02T0ktcEksSS02yy_1KTM_1MKzYpycxNBQDkiQ01
...
public:
    ...
    SELF() : Tuple(), fly_num_(), depDate_(), origin_(), time_() {}
    SELF(const Self & ot) : Tuple(), fly_num_(ot.fly_num_), depDate_(ot.depDate_), origin_(ot.origin_), time_(ot.time_) 
      { constructPayload(ot); }
    SELF(const fly_num_type & _fly_num, const depDate_type & _depDate, const origin_type & _origin, const time_type & _time) : Tuple(), fly_num_(_fly_num), depDate_(_depDate), origin_(_origin), time_(_time) { }
    ...
    {
        buf << fly_num_ << depDate_ << origin_ << time_;
    }
...
#undef SELF
#endif // BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZYPYCXNBQDKIQ01_H_ 
