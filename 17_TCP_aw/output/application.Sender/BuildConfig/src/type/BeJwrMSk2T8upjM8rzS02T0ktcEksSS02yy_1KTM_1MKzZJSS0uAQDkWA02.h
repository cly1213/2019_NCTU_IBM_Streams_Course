...
#ifndef BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZZJSS0UAQDKWA02_H_
#define BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZZJSS0UAQDKWA02_H_
...
public:
    ...
    SELF() : Tuple(), fly_num_(), depDate_(), origin_(), dest_() {}
    SELF(const Self & ot) : Tuple(), fly_num_(ot.fly_num_), depDate_(ot.depDate_), origin_(ot.origin_), dest_(ot.dest_) 
      { constructPayload(ot); }
    SELF(const fly_num_type & _fly_num, const depDate_type & _depDate, const origin_type & _origin, const dest_type & _dest) : Tuple(), fly_num_(_fly_num), depDate_(_depDate), origin_(_origin), dest_(_dest) { }
    ...
    {
        buf << fly_num_ << depDate_ << origin_ << dest_;
    }
...
#undef SELF
#endif // BEJWRMSK2T8UPJM8RZS02T0KTCEKSSS02YY_1KTM_1MKZZJSS0UAQDKWA02_H_ 
