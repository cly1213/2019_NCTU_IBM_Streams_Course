...
MY_OPERATOR_SCOPE::MY_OPERATOR::MY_OPERATOR()
{
  ...
  */
   ...
   osi->setParameter(env, setup, "className", SPL::rstring("com.ibm.nctu.AddTime"));
   osi->setParameter(env, setup, "classLibrary", SPL::rstring("bin"));
...
MY_BASE_OPERATOR::MY_BASE_OPERATOR()
 : Operator()  {
    ...
    param$className$0 = SPL::rstring("com.ibm.nctu.AddTime");
