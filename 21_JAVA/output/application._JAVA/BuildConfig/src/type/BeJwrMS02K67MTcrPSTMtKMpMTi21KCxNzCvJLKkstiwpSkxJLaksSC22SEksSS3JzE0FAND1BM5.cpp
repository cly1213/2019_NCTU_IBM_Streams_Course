...
#include "BeJwrMS02K67MTcrPSTMtKMpMTi21KCxNzCvJLKkstiwpSkxJLaksSC22SEksSS3JzE0FAND1BM5.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring symbol,float32 price,uint32 quantity,rstring tradetype,rstring datetime>",&initer));
