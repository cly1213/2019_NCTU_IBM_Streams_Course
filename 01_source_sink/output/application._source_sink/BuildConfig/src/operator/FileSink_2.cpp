// eJylkDFPwzAQhXV_1pWKOnVAxZCuoSA0JqnC6sFSWc6Umjm2dr7T594RILWJGN5zuDd9771J0me50ZKSyfLYOlfU95CCnyWGRZYLHiOIRqzM1qi_1G3VfTKlnUpk_1jrufXz7eNUvmmfqKqNZJM21CbLlX9EtarbXxf3dfZcTHDnOU7CWpblyUlJus_1AEAcw4ACu1NRiHOgPkVtUMh8n8KJDO7TFEd0mjX44PEHc5hCTusP5wpfXyJhSjb4uYKNgW6e_16kAFmh_0CcASvB4Qrs5s2f1eHUZNPKDnm5S00zTCwQXND0uQ34YXHSz




#include "./FileSink_2.h"
...
#define MY_BASE_OPERATOR FileSink_2_Base
#define MY_OPERATOR FileSink_2$OP
...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple$, uint32_t port)
{
    ...
    try {
        ...
        SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_name()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_title()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_department()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_salary()) << '\n';
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("FileSink_2",&initer));
    return true;
}
