...
#include "BeJwrMSk1NCgoyk8pTS6Jz0wpNjSEcvwSc1NLLQpLE_1NKMksq00wLijKTUwGaiBHd.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<uint32 product_id,rstring productName,uint32 quantity,float32 price>",&initer));
