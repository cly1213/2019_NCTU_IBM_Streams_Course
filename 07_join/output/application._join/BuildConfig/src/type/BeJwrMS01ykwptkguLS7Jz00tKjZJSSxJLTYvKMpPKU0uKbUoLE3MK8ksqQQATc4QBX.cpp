...
#include "BeJwrMS01ykwptkguLS7Jz00tKjZJSSxJLTYvKMpPKU0uKbUoLE3MK8ksqQQATc4QBX.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<uint32 id,rstring customer,rstring date,rstring product,uint32 quantity>",&initer));
