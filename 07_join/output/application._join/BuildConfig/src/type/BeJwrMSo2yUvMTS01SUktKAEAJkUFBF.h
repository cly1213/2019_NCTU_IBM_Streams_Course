...
#ifndef BEJWRMSO2YUVMTS01SUKTKAEAJKUFBF_H_
#define BEJWRMSO2YUVMTS01SUKTKAEAJKUFBF_H_
...
#define SELF BeJwrMSo2yUvMTS01SUktKAEAJkUFBF
...
public:
    ...
    SELF() : Tuple(), name_(), dept_() {}
    SELF(const Self & ot) : Tuple(), name_(ot.name_), dept_(ot.dept_) 
      { constructPayload(ot); }
    SELF(const name_type & _name, const dept_type & _dept) : Tuple(), name_(_name), dept_(_dept) { }
...
#undef SELF
#endif // BEJWRMSO2YUVMTS01SUKTKAEAJKUFBF_H_ 
