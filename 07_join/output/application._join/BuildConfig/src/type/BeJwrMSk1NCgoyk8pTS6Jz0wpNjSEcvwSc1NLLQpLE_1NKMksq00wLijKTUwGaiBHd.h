// t4u10product_ids11productNameu8quantityf5price


#ifndef BEJWRMSK1NCGOYK8PTS6JZ0WPNJSECVWSC1NLLQPLE_1NKMKSQ00WLIJKTUWGAIBHD_H_
#define BEJWRMSK1NCGOYK8PTS6JZ0WPNJSECVWSC1NLLQPLE_1NKMKSQ00WLIJKTUWGAIBHD_H_
...
#define SELF BeJwrMSk1NCgoyk8pTS6Jz0wpNjSEcvwSc1NLLQpLE_1NKMksq00wLijKTUwGaiBHd
...
public:
    ...
    SELF() : Tuple(), product_id_(), productName_(), quantity_(), price_() {}
    SELF(const Self & ot) : Tuple(), product_id_(ot.product_id_), productName_(ot.productName_), quantity_(ot.quantity_), price_(ot.price_) 
      { constructPayload(ot); }
    SELF(const product_id_type & _product_id, const productName_type & _productName, const quantity_type & _quantity, const price_type & _price) : Tuple(), product_id_(_product_id), productName_(_productName), quantity_(_quantity), price_(_price) { }
    ...
    {
        buf << product_id_ << productName_ << quantity_ << price_;
    }
    ...
    {
        size_t size = sizeof(SPL::uint32)+sizeof(SPL::uint32)+sizeof(SPL::float32);
...
#undef SELF
#endif // BEJWRMSK1NCGOYK8PTS6JZ0WPNJSECVWSC1NLLQPLE_1NKMKSQ00WLIJKTUWGAIBHD_H_ 
