// t5u2ids8customers4dates7productu8quantity


#ifndef BEJWRMS01YKWPTKGULS7JZ00TKJZJSSXJLTYVKMPPKU0UKBUOLE3MK8KSQQQATC4QBX_H_
#define BEJWRMS01YKWPTKGULS7JZ00TKJZJSSXJLTYVKMPPKU0UKBUOLE3MK8KSQQQATC4QBX_H_
...
#define SELF BeJwrMS01ykwptkguLS7Jz00tKjZJSSxJLTYvKMpPKU0uKbUoLE3MK8ksqQQATc4QBX
...
public:
    ...
    SELF() : Tuple(), id_(), customer_(), date_(), product_(), quantity_() {}
    SELF(const Self & ot) : Tuple(), id_(ot.id_), customer_(ot.customer_), date_(ot.date_), product_(ot.product_), quantity_(ot.quantity_) 
      { constructPayload(ot); }
    SELF(const id_type & _id, const customer_type & _customer, const date_type & _date, const product_type & _product, const quantity_type & _quantity) : Tuple(), id_(_id), customer_(_customer), date_(_date), product_(_product), quantity_(_quantity) { }
    ...
    {
        buf << id_ << customer_ << date_ << product_ << quantity_;
    }
...
#undef SELF
#endif // BEJWRMS01YKWPTKGULS7JZ00TKJZJSSXJLTYVKMPPKU0UKBUOLE3MK8KSQQQATC4QBX_H_ 
