// eJylUstOwzAQ1P4K4tzYoSqoN2gJ0KYBlHCuTLKlbhPb2Gus8PW4DxDlinzax8zOztqZdiAaYQjteJzJFkvtbY3AgcWXwtlgkFBvMLnBWbCLcsuLyZvut1emKkezTxZMsSlv649Q1rzI82eT3y55MV9s3TtjIZebefUS7oS8uW8G67MTut4WD_0yikkO_16EdmPs0eexc_0q9rOqqth2tdqUYaX69WSh9lE78A7Pa2kcwblUz4eW0dWqjfY5_1ght2q1oNEQAJK17jDBxqdpErTdOiNqTNjlcqOlShpBApRWyGAIq7g28FNSfpx0TTF_09YSZRYSVtp2gWJxGfHYIGNTuAybeke5yGX0ULayFm2Ir_0kxi23xTv2rdolARQNYjTLRyJBSBVJL23fBnCX7c7FQD299GG21_1nPj_1baADG50wVje_0pqVswEtFF2mcdMwVokP4dofBu4_1SJfW_1_02T8N3vtu5h9AWj_1L7n
...
#define MY_BASE_OPERATOR Inventory_Base
#define MY_OPERATOR Inventory$OP
...
{
    SPL::BeJwrMSk1NCgoyk8pTS6Jz0wpNjSEcvwSc1NLLQpLE_1NKMksq00wLijKTUwGaiBHd tuple$;
    double delay;
    ...
    try {
            ...
            failedRead = false;
                ...
                getPE().blockUntilShutdownRequest(delay);
                    ...
                    SPL::readCSV<SPL::uint32,','>(fs, tuple$.get_product_id());
                    
                        fs >> SPL::skipSpaceTabs;
                         
                            sep = fs.peek();
                            if (sep != ',') {
                                DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR (SPL::printableCharacter(','), SPL::printableCharacter(sep), _tupleNumber, "after reading the attribute product_id"));
                            }
                            fs >> sep;
                        
                    SPL::readCSV<SPL::rstring,','>(fs, tuple$.get_productName());
                    
                        fs >> SPL::skipSpaceTabs;
                         
                            sep = fs.peek();
                            if (sep != ',') {
                                DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR (SPL::printableCharacter(','), SPL::printableCharacter(sep), _tupleNumber, "after reading the attribute productName"));
                            }
                            fs >> sep;
                ...
                CHECK_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_TUPLE("tuple<uint32 product_id,rstring productName,uint32 quantity,float32 price>", _tupleNumber));
                CHECK_FAIL;
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("Inventory",&initer));
    return true;
}
