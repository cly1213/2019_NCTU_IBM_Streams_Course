...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple, uint32_t port) 
{
   ...
   if (! (1) ) 
       return;
   { OPort0Type otuple(iport$0.get_i(), iport$0.get_j(), lit$0, lit$1, lit$2, lit$3, lit$4, lit$5, lit$6); submit (otuple, 0);
 }
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("Functor_stream",&initer));
    return true;
}
