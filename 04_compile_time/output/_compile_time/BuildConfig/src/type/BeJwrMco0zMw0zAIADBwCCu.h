...
#ifndef BEJWRMCO0ZMW0ZAIADBWCCU_H_
#define BEJWRMCO0ZMW0ZAIADBWCCU_H_
...
#define SELF BeJwrMco0zMw0zAIADBwCCu
...
public:
    ...
    SELF() : Tuple(), i_(), j_() {}
    SELF(const Self & ot) : Tuple(), i_(ot.i_), j_(ot.j_) 
      { constructPayload(ot); }
    SELF(const i_type & _i, const j_type & _j) : Tuple(), i_(_i), j_(_j) { }
...
#undef SELF
#endif // BEJWRMCO0ZMW0ZAIADBWCCU_H_ 
