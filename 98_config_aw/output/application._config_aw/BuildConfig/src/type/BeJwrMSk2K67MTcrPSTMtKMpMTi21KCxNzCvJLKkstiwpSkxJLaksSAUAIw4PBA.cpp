...
#include "BeJwrMSk2K67MTcrPSTMtKMpMTi21KCxNzCvJLKkstiwpSkxJLaksSAUAIw4PBA.h"
#include <sstream>
...
{
    instantiators_.insert(std::make_pair("tuple<rstring symbol,float32 price,uint32 quantity,rstring tradetype>",&initer));
