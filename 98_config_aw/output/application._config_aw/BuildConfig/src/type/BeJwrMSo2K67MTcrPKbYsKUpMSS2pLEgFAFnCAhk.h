// t2s6symbols9tradetype


#ifndef BEJWRMSO2K67MTCRPKBYSKUPMSS2PLEGFAFNCAHK_H_
#define BEJWRMSO2K67MTCRPKBYSKUPMSS2PLEGFAFNCAHK_H_
...
#define SELF BeJwrMSo2K67MTcrPKbYsKUpMSS2pLEgFAFnCAhk
...
public:
    ...
    SELF() : Tuple(), symbol_(), tradetype_() {}
    SELF(const Self & ot) : Tuple(), symbol_(ot.symbol_), tradetype_(ot.tradetype_) 
      { constructPayload(ot); }
    SELF(const symbol_type & _symbol, const tradetype_type & _tradetype) : Tuple(), symbol_(_symbol), tradetype_(_tradetype) { }
...
#undef SELF
#endif // BEJWRMSO2K67MTCRPKBYSKUPMSS2PLEGFAFNCAHK_H_ 
