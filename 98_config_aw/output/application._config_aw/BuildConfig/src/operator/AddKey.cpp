// eJyNkEFvgzAMheW_1Uu1MUlp1HTdGh7RStkq0h51QAFNQIY6SMMR_0_1dJN3dbb5JOdvM9_0z6jOE5VQFnUQxG2HGQ26RJgDd_0XDzPOYnRSyR9yOOs3IT1b36aHU_06R4M8lRpVnmq93TKQ5jGYXN2WtmN6JJvzzzxaFdDum0Uskmfp3M_0OEA28N66U_0lTLPxGNb5fNxGdBFzt7tr7R2HbL8LAm2sbuUJAFhDPTKsBt9nI_0mzUaJE9rDOS5J1e8rFyCphBUiSyGEBtXPjWDeUKzq0ri8Gi7FGhJp0L6x73Dh9_1N1wKM07RIOx1O9aF4_1ooCEb_14EWRB0K6b5aPSBEJI0V0n454ECK9I_0L_16YHPWiXupn6gjq4Xn1ZICq8RPo745_0Hdoud
...
{
    SPL::BeJwrMSo2K67MTcrPKbYsKUpMSS2pLEgFAFnCAhk tuple$;
...
while(!getPE().getShutdownRequested()) {
    ...
    try {
            ...
            failedRead = false;
                ...
                CHECK_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_TUPLE("tuple<rstring symbol,rstring tradetype>", _tupleNumber));
                CHECK_FAIL;
		    ...
		    if (eolSep == EOF) {
                        ...
                        DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR ("\\n", SPL::printableCharacter(eolSep), _tupleNumber, "after reading the attribute tradetype"));
		    } 
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("AddKey",&initer));
    return true;
}
