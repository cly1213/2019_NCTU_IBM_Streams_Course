...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple$, uint32_t port)
{
    ...
    try {
        ...
        SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_symbol()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_datetime()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_price()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_vol()) << '\n';
