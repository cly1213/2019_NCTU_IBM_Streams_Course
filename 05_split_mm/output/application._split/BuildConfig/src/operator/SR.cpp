// eJydkV1vgjAUhnP_0itk1VGS6cIcfJPLhTMBk2Y0pcJidpSVtkeGvX7fFZd4uvXrbvk_16nOqOO7SmnUEVBBHjmMteVQhTIHZ5MHEc14wdukuMB5XlZy_0ZL7KiUvukfN3m_0UecViIrXg7XNH9Pio1vdvkivQ6bcPTDbCmc0_0SOMardlswK5vfZOO_0SdfQ86uFqeXHx5HujZeXDIWyO0yFeya8ysU_1hzDwQyPdpEChtFBNvAOCeZIsu1r3nuYNUZ93RCl3yeNSdvX9sW7emhoKQAgnMoLFuFnUHuZFDY3PZG4wUIjRStdTYw7XtRz_0BQKUvsOq1kW3K7LAohxPVa_0R0jBjy_0oYupeRIhS0Y1SOspNCGCvOtQUB2Uv2q_1HOi0IICH_1TYlpLDTYWAtUXDWvyz1Slmv7Lhkpq5b_1PFFnomzMwDQj4BO9yfCR
...
#define MY_BASE_OPERATOR SR_Base
#define MY_OPERATOR SR$OP
...
{
    SPL::BeJwrMSk2K67MTcrPKbZISSxJLcnMTXUzLSjKTE4tNS7LzwEAy4AMBn tuple$;
    double delay;
    ...
    try {
            ...
            failedRead = false;
                ...
                getPE().blockUntilShutdownRequest(delay);
                    ...
                    SPL::readCSV<SPL::rstring,','>(fs, tuple$.get_datetime());
                    
                        fs >> SPL::skipSpaceTabs;
                         
                            sep = fs.peek();
                            if (sep != ',') {
                                DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR (SPL::printableCharacter(','), SPL::printableCharacter(sep), _tupleNumber, "after reading the attribute datetime"));
                            }
                            fs >> sep;
                        
                    SPL::readCSV<SPL::float64,','>(fs, tuple$.get_price());
                    ...
                    SPL::readCSV<SPL::uint32,','>(fs, tuple$.get_vol());
                    
                CHECK_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_TUPLE("tuple<rstring symbol,rstring datetime,float64 price,uint32 vol>", _tupleNumber));
                CHECK_FAIL;
		    ...
		    if (eolSep == EOF) {
                        ...
                        DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR ("\\n", SPL::printableCharacter(eolSep), _tupleNumber, "after reading the attribute vol"));
		    } 
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("SR",&initer));
    return true;
}
