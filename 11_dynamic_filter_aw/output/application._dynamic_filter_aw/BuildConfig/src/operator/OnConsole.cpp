...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("OnConsole",&initer));
    return true;
}
...
::SPL::Functions::Utility::printStringLn(::SPL::spl_cast<SPL::rstring, SPL::BeJwrMSk2K67MTcrPSTMtKMpMTi21KCxNzCvJLKkstiwpSkxJLaksSAUAIw4PBA >::cast(iport$0));
