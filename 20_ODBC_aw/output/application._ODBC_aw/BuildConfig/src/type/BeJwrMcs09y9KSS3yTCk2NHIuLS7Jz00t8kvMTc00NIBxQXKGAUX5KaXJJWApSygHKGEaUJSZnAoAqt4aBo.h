// t6i7OrderIds12CustomerNamei10CustomerIds11ProductNamei9ProductIds5Price


#ifndef BEJWRMCS09Y9KSS3YTCK2NHIULS7JZ00T8KVMTC00NIBXQXKGAUX5KAXJJWAPSYGHKGEAUJSZNAOAQT4ABO_H_
#define BEJWRMCS09Y9KSS3YTCK2NHIULS7JZ00T8KVMTC00NIBXQXKGAUX5KAXJJWAPSYGHKGEAUJSZNAOAQT4ABO_H_
...
#define SELF BeJwrMcs09y9KSS3yTCk2NHIuLS7Jz00t8kvMTc00NIBxQXKGAUX5KaXJJWApSygHKGEaUJSZnAoAqt4aBo
...
public:
    ...
    SELF() : Tuple(), OrderId_(), CustomerName_(), CustomerId_(), ProductName_(), ProductId_(), Price_() {}
    SELF(const Self & ot) : Tuple(), OrderId_(ot.OrderId_), CustomerName_(ot.CustomerName_), CustomerId_(ot.CustomerId_), ProductName_(ot.ProductName_), ProductId_(ot.ProductId_), Price_(ot.Price_) 
      { constructPayload(ot); }
    SELF(const OrderId_type & _OrderId, const CustomerName_type & _CustomerName, const CustomerId_type & _CustomerId, const ProductName_type & _ProductName, const ProductId_type & _ProductId, const Price_type & _Price) : Tuple(), OrderId_(_OrderId), CustomerName_(_CustomerName), CustomerId_(_CustomerId), ProductName_(_ProductName), ProductId_(_ProductId), Price_(_Price) { }
    ...
    {
        buf << OrderId_ << CustomerName_ << CustomerId_ << ProductName_ << ProductId_ << Price_;
    }
...
#undef SELF
#endif // BEJWRMCS09Y9KSS3YTCK2NHIULS7JZ00T8KVMTC00NIBXQXKGAUX5KAXJJWAPSYGHKGEAUJSZNAOAQT4ABO_H_ 
